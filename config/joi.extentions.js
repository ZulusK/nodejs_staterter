...
/**
 * Creates new Joi extentions: email validation
 * @param {Joi} joi - Joi object
 * @returns new Joi extentions
 */
function EmailExtention(joi) {
  return {
    base: joi.string(),
    name: 'string',
    language: {
...
/**
 * Creates new Joi extentions: credit card validation
 * @param {Joi} joi - Joi object
 * @function
 */
function CreditCardExtention(joi) {
  return {
    base: joi.string(),
    name: 'string',
    language: {
...
/**
 * Creates new Joi extentions: mobile phone validation
 * @param {Joi} joi - Joi object
 */
function PhoneExtention(joi) {
  return {
    base: joi.string(),
    name: 'string',
    language: {
...
/**
 * Creates new Joi extentions: ObjectId validation
 * @param {Joi} joi - Joi object
 */
function ObjectIdExtention(joi) {
  return {
    base: joi.string(),
    name: 'string',
    language: {
